...
internal class F14Capture
{
    private readonly F14Page page;
    private readonly F14Configuration cfg;

    public F14Capture(F14Page page, F14Configuration cfg)
    {
        this.page = page;
        this.cfg = cfg;
    }
    ...
    {
        var configBefore = (F14Configuration)cfg.Clone();
    ...
    private void CaptureSteerpoints(WaypointCaptureData data, F14Configuration cfg)
    {
    ...
    private void UploadCapture(F14Configuration cfgBefore, F14Configuration cfgAfter)
    {
        var cfgUpload = (F14Configuration)cfgAfter.Clone();
    ...
    private static void RemoveIdenticalSteerpoints(F14Configuration cfgBefore, F14Configuration cfgAfter, F14Configuration cfgUpload)
    {
