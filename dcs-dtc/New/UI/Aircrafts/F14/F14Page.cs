...
using DTC.New.UI.Aircrafts.F14.Systems;
using DTC.New.UI.Base.Pages;
using DTC.New.UI.Base.Systems;
using DTC.New.Uploader.Aircrafts.F14;
using DTC.New.Uploader.Base;
using DTC.Utilities;
using DTC.Utilities.Network;
using static System.Windows.Forms.VisualStyles.VisualStyleElement.TextBox;

namespace DTC.New.UI.Aircrafts.F14;

public class F14Page : AircraftPage
{
    private F14Capture capture;

    public F14Page(Aircraft aircraft, Preset preset)
        : base(aircraft, preset)
    {
        this.capture = new(this, this.Configuration);
    }

    public new F14Configuration Configuration
    {
        get { return (F14Configuration)preset.Configuration; }
    }
    ...
    public void UploadToJet(F14Configuration cfg)
    {
        var upload = new F14Uploader((F14Aircraft)this.aircraft, cfg);
        upload.Execute();
    ...
    {
        var isToWpts = systems.Count == 1 && systems[0].PropertyName == nameof(F14Configuration.Waypoints);

        var cfgF18 = cfg as Presets.V2.Aircrafts.F14.F14Configuration;
    ...
    internal override Configuration ConvertConfigFromClipboard(Configuration cfg, List<ConfigurationSystem> systems)
    {
        ...
        var cfgResult = new F14Configuration();
    ...
    {
        return F14Kneeboard.GetKneeboardText(this.Configuration);
    }
}
